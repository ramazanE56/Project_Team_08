...
public class TC05_US014 extends TestBaseRapor {
    ...
    public void gecersizSifreIleSifreDegisikligiTesti(){
        ...
        extentTest.info("Email kutusuna kayıtlı kullanıcı email bilgisi girilir.");
        ...
        //Hatalı şifre password  kutusuna yazılır.
        smartcardlinkPage.currentPasswordElementi.sendKeys(ConfigReader.getProperty("invalidUserPassword"));
        extentTest.info("Hatalı şifre password  kutusuna yazılır.");
